...
/**
 * Clear the compiled views and cached routes for 2.60.42.
 *
 ...
 *
 * This release adds new routes (Catalog → Reorder's endpoints), so the
 * cached route table has to go or they won't resolve until it expires
 * naturally.
 */
