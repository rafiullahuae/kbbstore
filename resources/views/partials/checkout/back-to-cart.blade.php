...
@endphp
<a class="co-tocart co-tocart--{{ $style }}" href="{{ \App\Support\Url::to('/cart/') }}" aria-label="Go back to cart" title="Go back to cart">
    @if ($chev)
    ...
    @endif
    @if ($style !== 'icon_round')<span>Go back to cart</span>@endif
</a>
@endif
