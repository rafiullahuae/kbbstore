            ...
            <div class="formbox">
                <div class="sec co-ok">
                    ...
                    <dl class="co-facts">
                        ...
                        <div class="co-fact"><dt>{{ $order->paid_at ? __('store.order_received.fact_total_paid') : __('store.order_received.fact_total_to_pay') }}</dt><dd>{!! Money::format((int) $order->total) !!}</dd></div>
