...
| `web` and `auth:admin` (opened at line 181) and NoStoreAdminApi (opened at
| line 253) — beside the other requires, next to invoices-admin.php:
|
...
|
| WHEN THE HEADER ABOVE STOPS BEING TRUE, STRIKE IT. tests/Feature/
| RouteFileHeadersTest.php fails by name if routes/web.php requires this file
| while it still says "NOT WIRED YET" — fourteen files were once announcing
| themselves as unmounted while serving live traffic.
|
