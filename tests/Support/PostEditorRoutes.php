...
/**
 * Mounts routes/post-editor-admin.php the way the integrator is told to.
 *
 ...
 * until a package shipped an anonymous endpoint that can publish a page at the
 * site root of this shop's own domain.
 *
 ...
 *
 * A deliberate sibling of Tests\Support\ImportHistoryRoutes rather than a
 * shared base class: that file belongs to another lane and is not this one's to
 * change.
 */
final class PostEditorRoutes
{
    ...
    public static function wire(Application $app): void
    {
        ...
        RouteFacade::middleware(self::STACK)
            ->prefix('admin-api')
            ->group(base_path('routes/post-editor-admin.php'));
     ...
     *
     * Listed by exact URI rather than swept by prefix: `post-editor-` is this
     ...
     */
    public const URIS = [
        'admin-api/post-editor-bootstrap',
        'admin-api/post-editor-load/{id}',
        'admin-api/post-editor-slug',
        'admin-api/post-editor-create',
        'admin-api/post-editor-save/{id}',
    ];
